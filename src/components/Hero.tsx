...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[100dvh] w-full overflow-hidden">
      ...
      <motion.div
        className="absolute bottom-6 right-6 md:bottom-8 md:right-4 z-50 hidden md:flex flex-col items-center gap-3 cursor-pointer group"
      ...
      >
        ...
        >
          {/* Icon Container */}
          <div className="p-3 md:p-1 bg-black/20 md:bg-transparent backdrop-blur-sm md:backdrop-blur-[2px] rounded-full md:rounded-lg opacity-100 md:opacity-40 group-hover:opacity-100 transition-all duration-300 shadow-lg md:shadow-none border border-white/10 md:border-none">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-8 h-8 md:w-[70px] md:h-[70px] text-white drop-shadow-md"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <div className="hidden md:block text-white text-[10px] font-light tracking-widest uppercase drop-shadow-md text-center opacity-90">
